...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewById.setAdapter(new BaseQuickAdapter<String, BaseViewHolder>(R.layout.item, mUrls) {
                ...
                Glide.with(mContext).load(item)
                        .listener(new RequestListener<String, GlideDrawable>() {
                            ...
                            public boolean onResourceReady(GlideDrawable resource, String model,
                                                           ...
                                                           boolean isFirstResource) {
                                Log.e(TAG, "onResourceReady: " + item);
        ...
        viewById.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
